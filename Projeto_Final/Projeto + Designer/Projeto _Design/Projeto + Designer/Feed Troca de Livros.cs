...
namespace Projeto___Designer
{
    public partial class Troca_de_livros : Form
    {
        ...
        public Troca_de_livros(int idUsuario)
        {
        ...
        {
            Para_além_do_diário_de_Anne_Frank livro1= new Para_além_do_diário_de_Anne_Frank(idUsuario);
            this.Hide();
            livro1.ShowDialog();
        }
        ...
        {
            A_mente_de_Adolf_Hitler livro2 = new A_mente_de_Adolf_Hitler(idUsuario);
            this.Hide();
            livro2.ShowDialog();
        }
        ...
        {
            Assinato_na_casa_do_pastor livro3 = new Assinato_na_casa_do_pastor(idUsuario);
            this.Hide();
            livro3.ShowDialog();
        }
        ...
        {
            O_homem_de_giz livro5 = new O_homem_de_giz(idUsuario);
            this.Hide();
            livro5.ShowDialog();
        }
        ...
        {
            Pessoas_normais livro6= new Pessoas_normais(idUsuario);
            this.Hide();
            livro6.ShowDialog();
        }
        ...
        {
            A_vida_invisível_de_Addie_Larue livro7 = new A_vida_invisível_de_Addie_Larue(idUsuario);
            this.Hide();
            livro7.ShowDialog();
        }
        ...
        {
            Um_de_nós_está_mentindo livro8 = new Um_de_nós_está_mentindo(idUsuario);
            this.Hide();
            livro8.ShowDialog();
        }
