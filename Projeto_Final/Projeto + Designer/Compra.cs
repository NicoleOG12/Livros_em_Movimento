...
namespace Projeto___Designer
{
    public partial class Compra : Form
    {
        ...
        public Compra(int idUsuario, string Nome_item_txt, int Quantidade_numericUpDown1, string Preço_txt)
        {
            InitializeComponent();
            dao.Conectar();
            ...
            this.Preco.Text = Valor().ToString();
        }
        public double Valor()
        {
            double valor1= 0;
            DataTable dt = dao.GetProdutos(NomedoProduto_Box.Text);
            valor1 = double.Parse(dt.Rows[0].ItemArray[4].ToString()); 
            return valor1;
        }
